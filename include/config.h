...
/*
 * Set CONF_WITH_ROMDISK to add support for a ROM disk on drive 'Z'.
...
/*
 * Set CONF_WITH_KPRINTF if the target implements kprintf_outc.
 */
#ifndef CONF_WITH_KPRINTF
# define CONF_WITH_KPRINTF 0
#endif

/* Determine if kprintf() is available */
#if CONF_WITH_UAE || DETECT_NATIVE_FEATURES || STONX_NATIVE_PRINT || CONSOLE_DEBUG_PRINT || RS232_DEBUG_PRINT || SCC_DEBUG_PRINT || DUART_DEBUG_PRINT || COLDFIRE_DEBUG_PRINT || MIDI_DEBUG_PRINT || CARTRIDGE_DEBUG_PRINT || CONF_WITH_KPRINTF
...
# error Only one of CONSOLE_DEBUG_PRINT, RS232_DEBUG_PRINT, SCC_DEBUG_PRINT, COLDFIRE_DEBUG_PRINT or MIDI_DEBUG_PRINT or CARTRIDGE_DEBUG_PRINT must be set to 1.
#endif
